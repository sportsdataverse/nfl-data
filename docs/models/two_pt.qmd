...
- **Resolved (2026-09-01, PR #28):** `_stage.gate_status()` labels the soft
  gate `SOFT PASS` / `SOFT FAIL` in the console, `models/ledger.jsonl`,
  report.md and the train-all summary, so it can never read as a hard-gate
  `PASS`; the 0.99 floor is unchanged.
