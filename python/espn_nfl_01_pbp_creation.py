"""Builder: ESPN NFL play-by-play (NFLPlayProcess output, one row per play).
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_01_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_01_pbp_creation.py -s 2025 -e 2025
"""
