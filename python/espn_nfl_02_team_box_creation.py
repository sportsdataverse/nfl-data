"""Builder: ESPN NFL team box score.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_02_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_02_team_box_creation.py -s 2025 -e 2025
"""
