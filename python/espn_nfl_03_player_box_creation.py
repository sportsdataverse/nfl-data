"""Builder: ESPN NFL player box score.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_03_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_03_player_box_creation.py -s 2025 -e 2025
"""
