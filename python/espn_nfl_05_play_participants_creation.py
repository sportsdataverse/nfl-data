"""Builder: ESPN NFL per-play participants.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_05_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_05_play_participants_creation.py -s 2025 -e 2025
"""
