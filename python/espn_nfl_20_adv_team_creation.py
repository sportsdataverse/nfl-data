"""Builder: ESPN NFL advanced box: team.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_20_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_20_adv_team_creation.py -s 2025 -e 2025
"""
