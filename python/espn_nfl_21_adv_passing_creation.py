"""Builder: ESPN NFL advanced box: passing.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_21_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_21_adv_passing_creation.py -s 2025 -e 2025
"""
