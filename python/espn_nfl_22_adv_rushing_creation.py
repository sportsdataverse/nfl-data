"""Builder: ESPN NFL advanced box: rushing.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_22_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_22_adv_rushing_creation.py -s 2025 -e 2025
"""
