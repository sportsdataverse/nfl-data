"""Builder: ESPN NFL advanced box: defensive.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_24_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_24_adv_defensive_creation.py -s 2025 -e 2025
"""
