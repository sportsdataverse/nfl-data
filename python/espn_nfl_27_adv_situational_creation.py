"""Builder: ESPN NFL advanced box: situational.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_27_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_27_adv_situational_creation.py -s 2025 -e 2025
"""
