"""Builder: ESPN NFL advanced box: defensive players.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_28_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_28_adv_defensive_players_creation.py -s 2025 -e 2025
"""
