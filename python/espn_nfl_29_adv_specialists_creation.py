"""Builder: ESPN NFL advanced box: specialists.
...
Numbered like the cfb family (``cfbfastR-cfb-data/python/espn_cfb_29_*``) so the
two chains stay comparable by eye.

Example:
    One season::

        uv run python python/espn_nfl_29_adv_specialists_creation.py -s 2025 -e 2025
"""
