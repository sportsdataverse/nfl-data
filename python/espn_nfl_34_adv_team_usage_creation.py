"""Builder: ESPN NFL usage box: team usage (third down over expected, red-zone and scoring-opportunity efficiencies).
...
Example:
    One season::
        ...
        uv run python python/espn_nfl_34_adv_team_usage_creation.py -s 2025 -e 2025
"""
