"""Builder: ESPN NFL special teams: punters (gross and net, inside the 20, returns allowed).
...
Example:
    One season::
        ...
        uv run python python/espn_nfl_37_adv_st_punters_creation.py -s 2025 -e 2025
"""
