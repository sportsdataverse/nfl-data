"""Builder: ESPN NFL season leaderboard: tackle share by position group.
...
Example:
    One season::
        ...
        uv run python python/espn_nfl_53_usage_position_group_tackles_creation.py -s 2025 -e 2025
"""
