...
Usage::
    ...
    from model_training.play_level.fetcher import build_raw_library
...
# The nflverse game_id rule and the club-abbreviation fixups graduated to
# sportsdataverse.nfl.shield_pbp.game_id with the Shield parser (sdv-py #528) --
# the library builds ids for live games too, and two copies of the relocation
# table would drift. Re-exported so this module's callers and tests/test_fetcher.py
# keep their import path.
from sportsdataverse.nfl.shield_pbp.game_id import (  # noqa: F401
    _NFLVERSE_ABBR_FIXUPS,
    _RELOCATIONS,
    _nflverse_abbr,
    _team_abbr,
    nflverse_game_id,
