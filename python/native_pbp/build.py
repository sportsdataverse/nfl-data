"""``build_pbp`` / ``build_pbp_from_file`` / ``build_season``.

**Moved.** This module graduated to
:mod:`sportsdataverse.nfl.shield_pbp.build` (sportsdataverse-py #528): the same
...
there -- this file is a compat shim so every ``from native_pbp.build import
...
from sportsdataverse.nfl.shield_pbp.build import *  # noqa: F401,F403
