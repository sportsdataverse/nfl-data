"""The play-text regex layer (pass_location, run_location, penalties).

**Moved.** This module graduated to
:mod:`sportsdataverse.nfl.shield_pbp.description` (sportsdataverse-py #528): the same
...
there -- this file is a compat shim so every ``from native_pbp.description import
...
from sportsdataverse.nfl.shield_pbp.description import *  # noqa: F401,F403
