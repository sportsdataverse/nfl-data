"""Timeouts, score_differential, game_half, seconds, roof, era and the spread join.

**Moved.** This module graduated to
:mod:`sportsdataverse.nfl.shield_pbp.features` (sportsdataverse-py #528): the same
...
there -- this file is a compat shim so every ``from native_pbp.features import
...
from sportsdataverse.nfl.shield_pbp.features import *  # noqa: F401,F403
