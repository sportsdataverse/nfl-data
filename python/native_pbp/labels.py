"""EP/WP/CP label sources (sp, touchdown, td_team, field_goal_result, safety, result).

**Moved.** This module graduated to
:mod:`sportsdataverse.nfl.shield_pbp.labels` (sportsdataverse-py #528): the same
...
there -- this file is a compat shim so every ``from native_pbp.labels import
...
from sportsdataverse.nfl.shield_pbp.labels import *  # noqa: F401,F403
