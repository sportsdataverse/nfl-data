"""nflfastR's hardcoded per-game repairs, the scramble backfill and weird passes.

**Moved.** This module graduated to
:mod:`sportsdataverse.nfl.shield_pbp.repairs` (sportsdataverse-py #528): the same
...
there -- this file is a compat shim so every ``from native_pbp.repairs import
...
from sportsdataverse.nfl.shield_pbp.repairs import *  # noqa: F401,F403
