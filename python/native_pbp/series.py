...
:mod:`sportsdataverse.nfl.shield_pbp.series` (sportsdataverse-py #528): the same
...
there -- this file is a compat shim so every ``from native_pbp.series import
...
from sportsdataverse.nfl.shield_pbp.series import *  # noqa: F401,F403
from sportsdataverse.nfl.shield_pbp.series import (  # noqa: F401
    _OUTPUT_SCHEMA,
)
